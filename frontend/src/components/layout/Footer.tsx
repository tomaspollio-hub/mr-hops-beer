          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-hops-muted hover:text-green-400 transition-colors"
              >
              ...
              <a
                href={INSTAGRAM}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-hops-muted hover:text-pink-400 transition-colors"
              >
                <span className="text-pink-400"><IconInstagram /></span>
                @mr.hopsbeer
              </a>
              <a
                href={FACEBOOK}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-hops-muted hover:text-blue-400 transition-colors"
              >
              ...
              <a
                href={THREADS}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-hops-muted hover:text-hops-white transition-colors"
              >
